...
def inicializar_camara():
    ...
    """
    try:
        cam.init() # Inicializar la cámara en formato JPEG
...
def tomar_foto():
    ...
    try:
        foto = cam.capture() # Capturar la imagen
        if foto:
        ...
        print('Error al tomar la foto:', ex)
        return None
...
def iniciar_servidor(ip):
    ...
    s.listen(5) # Escuchar conexiones entrantes (1 cliente a la vez)
